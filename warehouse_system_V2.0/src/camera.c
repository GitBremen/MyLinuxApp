...
void *pthread_camera(void *args)
{
    ...
    /*检查是否是V4L2_CAP_VIDEO_CAPTURE_MPLANE型设备*/
    ...
    //  ffmpeg -f rawvideo -pix_fmt nv12 -s 640x640 -i output.yuv output.mp4
    //  ffmpeg -i pre.mp4 -vcodec h264 pre.h264
